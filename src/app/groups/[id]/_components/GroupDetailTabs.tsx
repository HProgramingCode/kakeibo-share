...
import { GroupDetailTabBar } from "./GroupDetailTabBar";
import { GroupDetailTabPanels } from "./GroupDetailTabPanels";
import { tabFromHash } from "./group-detail-tab-id";
...
export type { GroupDetailTabId } from "./group-detail-tab-id";
